...
function setBoard() {
  ...
  emptyLoc = new Object();
  emptyLoc.x = Math.floor(Math.random() * 3);
  emptyLoc.y = Math.floor(Math.random() * 3);
...
function getMapImage2() {

  // SOURCE: https://github.com/wf9a5m75/phonegap-googlemaps-plugin/wiki/Map.toDataURL%28%29
...
/*
  var mapImageUrl = document.getElementById('map').toDataURL('image/png', 1);
